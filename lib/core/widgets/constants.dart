import 'package:flutter_hackathone_2024/core/widgets/toast_widget.dart';
...
class Constants {
  ...
  static onSuccess(BuildContext context, {String? message, String? title}) {
    showTOAST(context,
        textToast: message, title: title, status: ToastStatus.success);
  }
  ...
  static onNetworkFailure(BuildContext context,
      {NetworkExceptions? networkException, String? title}) {
    onFailure(context,
